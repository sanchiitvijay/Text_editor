...
main_application.geometry('1300x700')
...
file_menu.add_command(label = 'Save As' , image = saveas_icon , compound=  tk.LEFT , accelerator='ctrl+alt+S',command=save_as_file)
...
edit_menu.add_command(label = 'Clear All' , image = clearall_icon , compound=  tk.LEFT , accelerator='ctrl+alt+x',command=lambda:text_editor.delete(1.0,tk.END))
...
view_menu.add_checkbutton(label='Status Bar' ,onvalue=1,offvalue=0,variable=show_statusbar ,image = statusbar_icon, compound=tk.LEFT,command=hide_statusbar)
